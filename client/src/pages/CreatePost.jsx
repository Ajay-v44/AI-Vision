  ...
  return (
    <section className='max-w-7x1 mx-auto'>
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]" >Create imaginative and visually stunning images through  Open  AI By Ajay  and showcase them through community </p>
